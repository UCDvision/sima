...
class ClassAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        k = F.normalize(k, p=1.0, dim=-2, eps=1e-6)
        q = F.normalize(q, p=1.0, dim=-2, eps=1e-6)
        qc = q[:, :, 0:1]  # CLS token
        attn_cls = (qc * k).sum(dim=-1)
...
@register_model
def sima_nano_12_p16(pretrained=False, **kwargs):
...
@register_model
def sima_tiny_12_p16(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_small_12_p16(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_tiny_24_p16(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_small_24_p16(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_medium_24_p16(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_large_24_p16(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_nano_12_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_tiny_12_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_small_12_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_tiny_24_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_small_24_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_medium_24_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
...
@register_model
def sima_large_24_p8(pretrained=False, **kwargs):
    model = SimAVisionTransformer(
